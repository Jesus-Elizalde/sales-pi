...
export function MonthView({ currentDate, selectedDate, onSelectDate, entries, onEntryClick }: MonthViewProps) {
                ...
                >
                  ...
                  <div className="text-xs space-y-0.5">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-green-600">${entry.cashTotal.toFixed(0)}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Card:</span>
                      <span className="font-medium text-blue-600">${entry.cardTotal.toFixed(0)}</span>
                    </div>
                    <div className="flex justify-between border-t pt-0.5">
                      <span className="font-semibold">Total:</span>
                      <span className="font-semibold">${entry.totalAmount.toFixed(0)}</span>
                    </div>
                  </div>
                </div>
              )}
