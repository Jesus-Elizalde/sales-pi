...
export function WeekView({ currentDate, entries, onEntryClick }: WeekViewProps) {
              ...
              <div className="space-y-2">
                ...
                <div className="bg-white rounded p-2 space-y-1">
                  ...
                  <div className="flex justify-between text-xs">
                    ...
                    <span className="font-medium text-green-600">${entry.cashTotal.toFixed(2)}</span>
                  </div>
                  <div className="flex justify-between text-xs">
                    <span className="text-gray-600">Card:</span>
                    <span className="font-medium text-blue-600">${entry.cardTotal.toFixed(2)}</span>
                  </div>
